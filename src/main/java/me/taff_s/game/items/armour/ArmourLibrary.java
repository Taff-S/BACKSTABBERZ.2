...
public class ArmourLibrary {
    ...
    // enemy armours (removed duplicate names)
    public static final Armour enemyClothShirt = new Armour("Slipshod Armour", "Bits and pieces of cobbled together into a fascimile of armour", 5, 2);
    public static final Armour enemyLeatherArmour = new Armour("Basic Armour", "A practical set of dented but usable armour", 15, 3);
    public static final Armour enemyChainmailArmour = new Armour("Full Armour", "A helm, breastplate and greaves that look too good to be scavenged", 35, 4);
